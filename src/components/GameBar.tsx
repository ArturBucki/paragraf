  ...
  if (ready) {
    return (
      <button
        ...
        className="mb-2 flex w-full items-center gap-3 rounded-2xl border-2 border-[#8FE3C2] bg-[#8FE3C2]/15 px-3 py-3 text-left transition active:scale-[0.99]"
      >
        <span className="relative flex h-10 w-10 flex-none items-center justify-center rounded-xl bg-[#8FE3C2]/20">
          <Icon name={ready.icon} className="h-5 w-5 text-berry" />
          <span className="absolute inset-0 animate-ping rounded-xl bg-[#8FE3C2]/25" />
        </span>
        ...
        <span className="flex-none rounded-full bg-[#8FE3C2] px-4 py-2 text-sm font-extrabold text-[#06281A]">
          START
        </span>
      </button>
    );
  ...
  if (invited) {
    return (
      ...
      >
        ...
        <span className="flex-none rounded-full bg-berry px-3.5 py-2 text-xs font-extrabold text-[#06281A]">
          Wchodzę
        </span>
      </button>
    );
